...
def test_network(model,
    ...
    output_dir = os.path.join(cfg.work_dir, f'eval_{dataset.__class__.__name__}_{dataset.name}')
    ...
    mmcv.dump(eval_results, os.path.join(output_dir, f'{prefix}_eval_results.json'))
