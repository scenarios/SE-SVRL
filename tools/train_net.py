...
def parse_args():
    ...
    parser.add_argument('--work_dir',
                        help='the dir to save logs and models.'
                             'if not specified, program will use the path defined'
                             'in the configuration file.')
    parser.add_argument('--data_dir', default='data/', type=str,
                        help='the dir that save training data. (data/ by default)')
...
if __name__ == '__main__':
    ...
    '''
    #IF DEBUG
    args.cfg = 'configs/manifoldlearning/r2plus1d_18_ucf101/pretraining.py'
    args.work_dir = '/data/yizhou/log/srstcp/temp/debug_manifoldlearning'
    args.data_dir = '/data/yizhou/'
    args.validate = False
